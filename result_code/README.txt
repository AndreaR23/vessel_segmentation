...
CD je členěno na 2 hlavní celky: MaskRCNN a UNET + složku obsahující příklady obrazů a PDF soubor s textem práce.
...
data:
-----
Složka data obsahuje trénovací a validační obrazy pro optické disky a cévy - train_disks a train_vessels a obrazy pro zhodnocení segmentace optických disků a cév na registrovaných sekvencích - reg_disks a reg_vessels.
